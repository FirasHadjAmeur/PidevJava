...
public class Favoris {
    ...
    public Favoris(Object id, Object tournoi_id, Object equipe1_id, Object equipe2_id, Object date_match, Object ref_match,Object score_a, Object score_b) {
       this.id = (int) id;
    ...
    public Favoris(Object tournoi_id, Object equipe1_id, Object equipe2_id, Object date_match, Object ref_match,Object score_a, Object score_b) {
         this.tournoi_id = (int) tournoi_id;
        this.equipe1_id = (int) equipe1_id;
        this.equipe2_id = (int) equipe2_id;
        this.date_match = (Date) date_match;
    ...
    public String toString() {
        return "Favoris{" + "id=" + id + ", tournoi_id=" + tournoi_id + ", equipe1_id=" + equipe1_id + ", equipe2_id=" + equipe2_id + ", date_match=" + date_match + ", ref_match=" + ref_match + ", score_a=" + score_a + ", score_b=" + score_b + ", nom_tournoi=" + nom_tournoi + ", nom_equipe1=" + nom_equipe1 + ", nom_equipe2=" + nom_equipe2 + '}';
    }
